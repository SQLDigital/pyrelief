...
(function (c) {
    ...
    function dc(a) {
        ...
        if (p = e.attr("href") || e.attr("data-href")) {
            ...
            b = p;
            if (b = -1 !== b.search("youtube.com") ? "youtube" : -1 !== b.search("vimeo.com") ? "vimeo" : "mp4" === a ? "local" : !1) e.data("type", b), e.attr("data-thumbnail") || ("vimeo" === b ? Xc(e, p) : "youtube" === b && e.attr("data-thumbnail", "https://img.youtube.com/vi/" + p.split("https://www.youtube.com/watch?v=")[1] + "/1.jpg"));
    ...
    var k = {
        ...
        dd = "https://player.vimeo.com/video{url}?title=0&byline=0&portrait=0&autoplay={autoplay}&color=FFFFFF&wmode=transparent",
        cd = "https://www.youtube.com/embed/{url}?autoplay={autoplay}&autohide=1&hd=1&iv_load_policy=3&showinfo=0&showsearch=0&wmode=transparent",
